                          ...
                          <div class="card-body">
                              ...
                              <form class="m-t-40"  id="post-form" >
                                ...
                                <div class="form-group m-b-40">
                                    ...
                                    <input type="hidden" class="form-control" value="{{$post->id}}" name="id" id="title" required >


                                </div>
                                  <div class="form-group m-b-40">
                                      <label for="input1">Post Title</label>
                                      <input type="text" class="form-control" value="{{$post->posttitle}}" name="title" id="title">
                                      <span class="bar"></span>
                                  ...
                                  <div class="form-group m-b-40">
                                    <label for="input2"> Post Description</label>
                                      ...
                                      <textarea name="description" class="form-control"  id="content">{{$post->description}}</textarea>
                                      <span class="bar"></span>
                                  </div>
                                  ...
                                  <div class="form-group m-b-40">
                                    <label for="input2"> Post Image</label>
                                      ...
                                      <input type="file" name="images" value="{{old('images')}}" class="form-control" onchange="readURL(this);" >
                                        <img id="blah" src="{{url('/assets/blogposts')}}/{{$post->image}}" height="200" width="100" style="border: 1px solid #ddd;
  border-radius: 4px;
  padding: 5px;
  width: 150px;"  alt="Your selected image..." />
                                  ...
                                  <div class="form-group m-b-40">
                                    <label for="input2"> Image AltText</label>
                                      ...
                                      <input type="text" name="alttext" value="{{$post->alttext}}" class="form-control" id="alttext">
                                      <span class="bar"></span>
                                  </div>
