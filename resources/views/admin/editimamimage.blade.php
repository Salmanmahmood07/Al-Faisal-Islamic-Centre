                              ...
                              <form class="m-t-40"  id="imam-form" enctype="multipart/form-data" >
                                ...
                                {!! csrf_field() !!}
                                  <div class="form-group m-b-40">
                                    <input type="hidden" class="form-control" value="{{$imam->id}}" name="id" id="id" required >
                                    
                                    <label for="input2">  Image</label>

                                      <input type="file" name="image" value="{{old('images')}}" class="form-control" onchange="readURL(this);">
                                        <img id="blah" src="{{url('/assets/imamsimages')}}/{{$imam->image}}" height="200" width="100" style="border: 1px solid #ddd;
  border-radius: 4px;
  padding: 5px;
  width: 150px;"  alt="Your selected image..." />
                                  ...
                                  <div class="form-group m-b-40">
                                    <label for="input2"> Image AltText</label>
                                      ...
                                      <input type="text" name="alttext" value="{{$imam->alttext}}" class="form-control">
                                      <span class="bar"></span>
                                  </div>
