<header class="topbar">
        <nav class="navbar top-navbar navbar-expand-md navbar-light">
            ...
            color: #fff;">
                ...
                <!-- Logo text --><span>
                    <!-- dark Logo text -->
                <a class="sm-hidden text-white" href="{{url('/')}}/admin/dashboard">Online Portal</a>
                    <!-- Light Logo text -->
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-video"></i><span class="hide-menu">Manage Media</span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{url('admin/newslist')}}">News and Events</a></li>
                        <li><a href="{{url('/admin/getallimages')}}">Images</a></li>
                ...
                <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-file"></i><span class="hide-menu">Facilities</span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{url('admin/allservices')}}">Services</a></li>
                        <li><a href="{{url('/admin/allcourses')}}">Courses</a></li>
                        <li><a href="{{url('/admin/allprojects')}}">Upcoming Projects</a></li>
                    </ul>
                </li>
                ...
                <!-- <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-pencil"></i><span class="hide-menu">About</span></a>
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li><a href="{{url('/admin/addvision')}}">Vision</a></li>
                    </ul>
                </li> -->
                <li> <a class="waves-effect waves-dark" href="{{url('/admin/allhistory')}}">
                ...
                <!--<li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false">
                        ...
                        <ul aria-expanded="false" class="collapse">
                            <li><a href="{{url('admin/meetinginvite')}}">Create Invitations</a></li>
                            <li><a href="{{url('/admin/getallinvite')}}">All Meetings</a></li>
                        </ul>
                </li>-->

                <li> <a class="waves-effect waves-dark" href="{{url('/admin/allblogposts')}}">
                        <i class="mdi mdi-blogger"></i><span class="hide-menu">Blog Posts</span></a>
                </li>

                <li> <a class="waves-effect waves-dark" href="{{url('/admin/getallimams')}}">
                        <i class="mdi mdi-account"></i><span class="hide-menu">Manage Team</span></a>

                </li>
                <li> <a class="waves-effect waves-dark" href="{{url('/admin/getallcontacts')}}">
