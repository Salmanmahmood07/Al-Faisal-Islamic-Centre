...
@endsection
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-2">
    <a href="{{url('admin/addhistoryimages',$history->id)}}"><button type="button" class="btn waves-effect waves-light  btn-info" data-toggle="modal" data-target="#exampleModal"
         style="margin-left:900px;">Update Images</button></a>
      </div>
      </div>
    <!-- <div class="col-md-2">
    <a href="{{url('admin/allhistory')}}"><button type="button" class="btn waves-effect waves-light  btn-success del-button"
                              ...
                              <form class="m-t-40"  id="history-form" enctype="multipart/form-data">
                                ...
                                {!! csrf_field() !!}
                                  <div class="form-group m-b-40">
                                    ...
                                    <input type="hidden" class="form-control" value="{{$history->id}}" name="id" id="title" required >

                                      <label for="input1">History Title</label>
                                      <input type="text" class="form-control" value="{{$history->title}}" name="title" id="title">
                                      <span class="bar"></span>
