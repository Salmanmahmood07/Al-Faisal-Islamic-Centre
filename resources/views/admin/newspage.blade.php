  ...
  width: 150px;"  alt="Your selected image..." />
                                  ...
                                  <div class="form-group m-b-40">
                                    ...
                                    <select class="form-control p-0" id="input6" name="speaker" required>
                                        ...
                                        @foreach($speaker as $speakr)
                                        <option value="{{$speakr->id}}">{{$speakr->imamname}}</option>
                                        @endforeach
                                         </select>
                                      <span class="bar"></span>
                                  </div>
                                  ...
                                  <div class="form-group m-b-40">
                                    <label for="input2"> Event Time</label>
                                      ...
                                      <input type="text" name="time" value="{{old('time')}}" class="form-control"  required>
                                      <span class="bar"></span>
                                  </div>
                                  <div class="form-group m-b-40">
