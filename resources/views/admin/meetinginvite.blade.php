                              ...
                              <form class="m-t-40"  id="meeting-form" enctype="multipart/form-data" >
                                ...
                                {!! csrf_field() !!}
                                  <div class="form-group m-b-40">
                                   ...
                                   <input type="text" class="form-control" value="{{old('title')}}" name="topic" id="topic" required >
                                  <span class="bar"></span>
                                </div>
                                <div class="form-group m-b-40">
                                   <label for="input2"> Agenda</label>
                                   <input type="text" class="form-control" value="{{old('title')}}" name="agenda" id="agenda" required >
                                  <span class="bar"></span>
                                </div>
                                <div class="form-group m-b-40">
                                   <label for="input2">Date</label>&nbsp;<span class="bar">Format:&nbsp;M/D/Y&nbsp;Time&nbsp;(02/04/2021&nbsp;01:38 PM)</span>
                                   <input type="text" class="form-control" value="{{old('title')}}" name="start_time" id="start_time" required >
                                  <span class="bar"></span>
                                </div>
