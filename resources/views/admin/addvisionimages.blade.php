                              ...
                              <form class="m-t-40"  id="vision-form" enctype="multipart/form-data" >
                                ...
                                {!! csrf_field() !!}
                                  <div class="form-group m-b-40">
                                    <input type="hidden" class="form-control" value="{{$vision->id}}" name="id" id="title" required >
                                    <label for="input2">  Image</label>

                                      <input type="file" name="images[]" value="{{old('images')}}" class="form-control"  required onchange="readURL(this);" multiple="" >
