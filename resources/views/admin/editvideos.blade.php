                              ...
                              <form class="m-t-40"  id="video-form" enctype="multipart/form-data" >
                                ...
                                <input type="hidden" name="id" value="{{$video->id}}">
                                  <div class="form-group m-b-40">
                                      ...
                                      <input type="text" class="form-control" value="{{$video->videotitle}}" name="title" id="title">
                                      <span class="bar"></span>
                                  ...
                                  <div class="form-group m-b-40">
                                    ...
                                    <input type="text" class="form-control" value="{{$video->category}}" name="category" id="category">
                                      <span class="bar"></span>
                                  </div>
                                  <div class="form-group m-b-40">
                                    <label for="input2"> Video Embed</label>

                                      <input type="text" name="videoembed" value="{{$video->video_embed_src}}" class="form-control">
                                  ...
                                  <div class="form-group m-b-40">
                                    <label for="input2"> Video AltText</label>
                                      ...
                                      <input type="text" name="alttext" value="{{$video->alttext}}" class="form-control">
                                      <span class="bar"></span>
                                  </div>
