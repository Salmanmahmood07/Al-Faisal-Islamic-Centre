                          ...
                          <div class="card-body">
                              ...
                              <form class="m-t-40"  id="video-form" enctype="multipart/form-data" >
                                ...
                                {!! csrf_field() !!}
                                 ...
                                 <option value="{{$cat->id}}" id="catoption">{{$cat->categorytitle}}</option>
                               @endforeach
                                         </select>
                                      <span class="bar"></span>
                                  </div>
                                  <div class="form-group m-b-40">
                                    <label for="input2"> Video Embed</label>
                                      ...
                                      <input type="text" name="videoembed" value="{{old('videoembed')}}" class="form-control"  required  >
                ...
                callback: function(){
                  ...
                  jQuery('#category-form').submit(function(e){
                    ...
                    $.ajaxSetup({
                      ...
                      jQuery.ajax({
                        url: "{{ url('/admin/addvideocategory') }}",
                        method : 'post',
                        data: form_data,
                        success: function(result){
