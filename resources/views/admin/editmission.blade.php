...
@endsection
  ...
  <div class="container-fluid">
    <div class="row">
    <div class="col-md-2">
    <a href="{{url('admin/addmissionimages',$mission->id)}}"><button type="button" class="btn waves-effect waves-light  btn-info" data-toggle="modal" data-target="#exampleModal"
                              ...
                              <form class="m-t-40"  id="mission-form" enctype="multipart/form-data" >
                                ...
                                {!! csrf_field() !!}
                                  <div class="form-group m-b-40">
                                      ...
                                      <input type="text" class="form-control" value="{{$mission->title}}" name="title" id="title">
                                      <span class="bar"></span>
