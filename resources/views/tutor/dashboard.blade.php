                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 470px;"><div class="chat-box" style="overflow: hidden; width: auto; height: 470px;overflow-y: scroll !important;">
                                    ...
                                    <ul class="chat-list">
                                        <!--chat Row -->
                                        @foreach($gettopics as $rec)
                                        <li>
                                            <div class="chat-img"><img src="{{url('/admin_asset')}}/images/users/1.jpg" alt="user"></div>
                                            <div class="chat-content">
                                                <h5>{{$rec->username}}</h5>
                                                <div class="box bg-light-info">{{$rec->sub}}</div>
                                            </div>
                                            <!-- <div class="chat-time">{{date('d-M-Y', strtotime($rec->createdtime))}}</div> -->
                                            <div style="color:black;font-size:14px;margin-left:150px;">Posted on : {{$rec->created_at->diffForHumans($today)}}</div>
