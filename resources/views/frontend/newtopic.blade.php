      ...
      <div class="container" style="padding: 15px;">
        <div class="row">
                      <div class="col-lg-8 col-md-8">
                          ...
                          <!-- POST -->
                          <div class="post">
                              <form action="{{ url('/user/postquestion') }}" class="form newtopic" method="post" id="topic-form">
                          ...
                          <div class="post">
                              <div class="wrap-ut pull-left">
                                  ...
                                  <div class="posttext pull-left">
                                      <h2><a href="{{url('/user/singlequestion',$getdata->id)}}">{{$getdata->subject}}</a></h2>
                                      <p>{!!Illuminate\Support\Str::limit($getdata->question, $limit = 100, $end = '...')!!}</p>
                                  </div>
                                  <div class="clearfix"></div>
                              </div>
                              <div class="postinfo pull-left">
                                  ...
                                  <div class="time"><i class="fa fa-clock-o"></i>{{$getdata->created_at->diffForHumans($today)}}</div>
                              </div>
                              <div class="clearfix"></div>
                          </div><!-- POST -->
                          @endforeach
