          ...
          <div class="col-lg-8 col-xl-9">
            <div class="event-details">
              <div class="event-details__thumb">
                <img src="{{url('/assets/services')}}/{{$detail->image}}" style="width:100%;height:400px;" alt="Single event Details">
              </div>
              <h2 class="event-details__title">{{$detail->servicetitle}}</h2>
                  ...
                  <li>
                    <div class="wgt-recentpost__thumb">
                      <a href="{{url('/services_detail',$service->id)}}">
                        <img src="{{url('/assets/services')}}/{{$service->image}}" alt="event thumb">
                      </a>
                    </div>
                    <div class="wgt-recentpost__content">
                      <h5><a href="{{url('/services_detail',$service->id)}}">{{$service->servicetitle}}</a></h5>
                      <p><span>{{  date("d M Y", strtotime($service->created_at)) }}</span></p>
