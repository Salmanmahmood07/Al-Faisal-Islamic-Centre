                ...
                <figure class="activity wow fadeInLeft">
                  <div class="activity__thumb">
                    <a href="{{url('/project_detail',$project->id)}}">
                       <img src="{{url('/assets/projects')}}/{{$project->image}}" alt="activity image" style="height: 250px; width: 450px;">
                    </a>
                  </div>
                  <figcaption class="activity__content text-center">
                    <h3><a href="{{url('/project_detail',$project->id)}}">{{$project->projecttitle}}</a></h3>
                    <p>{!!Illuminate\Support\str::limit($project->description, 300,'...')!!}</p>
                    
                    <a href="{{url('/project_detail',$project->id)}}" class="cr-readmore">More Details</a>
