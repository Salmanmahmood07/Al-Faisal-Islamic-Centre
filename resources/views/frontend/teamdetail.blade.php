          ...
          <div class="col-lg-8 col-xl-9">
            <!-- <div class="event-details"> -->
                ...
                <div class="about-images clearfix"> 
                  ...
                  @endphp
                  <a href="{{url('/team_detail',$imamimage->id)}}">
                          <img class="wow fadeInUp {{$class}}" data-wow-delay="0.1s" src="{{url('/assets/imamsimages')}}/{{$imamimage->image}}" alt="about image">
                          </a>
                          @php
                            $i++;
                          @endphp
              ...
              <div class="calltoaction d-flex justify-content-left justify-content-md-center flex-wrap felx-md-nowrap">
                <h3>Let’s join the Class, know about {{$detail->designation}}...</h3>
                ...
                <div class="speakers">
                  ...
                  <div class="single-speaker">
                      ...
                      <div class="hexagon">
                        <div class="hexagon__inner1">
                          <div class="hexagon__inner2">
                            <img src="{{url('/assets/imams')}}/{{$detail->image}}" alt="speaker 1">
                    ...
                    <div class="signle-speaker__content">
                      <h5>{{$detail->imamname}}</h5>
                      <span>{{$detail->designation}}</span><br>
          ...
          <div class="col-lg-4 col-xl-3">
            ...
            <div class="sidebar widgets">
              ...
              <div class="single-widget wgt-recentpost">
                ...
                <ul>
                  @foreach($team_detail as $imam)
                  <li>
                    <div class="wgt-recentpost__thumb">
                      <a href="{{url('/team_detail',$imam->id)}}">
                        <img src="{{url('/assets/imams')}}/{{$imam->image}}" alt="event thumb">
                      </a>
                    </div>
                    <div class="wgt-recentpost__content">
                      <h5><a href="{{url('/team_detail',$imam->id)}}">{{$imam->imamname}}</a></h5>
                      <p><span>{{$imam->designation}}</span><span>{{$imam->about}}</span></p>
                    </div>
                  </li>
                  @endforeach
