...
.map-responsive iframe{
  					...
  					<div class="row">
  						<div class="col-lg-12 text-center">
  							<div class="cr-breadcrumb text-center">
  								<h2 class="cr-breadcrumb__title">{{__('contact.Our Contact')}}</h2>
                ...
                <div class="col-lg-4">
                  <div class="contact-sidebar">
                    <div class="small-title">
                      <h4>{{__('contact.Get in touch')}}</h4>
                      <p>{{__('contact.To give valuable suggestion Contact us')}} </p>
                    </div>
                    <ul class="contact-sidebar__body">
                      <li class="ct__address">
                        <p>{{__('contact.Al Faisal Islamic Center - Masjid Ahle Hadees, Plot Number، 379 Street # 3, Block R Phase 2 Johar Town, Lahore, Punjab, Pakistan')}}</p>
                      </li>
                      <li class="ct__phone">
                    ...
                    <div class="contact-sidebar__social">
                      <h5>{{__('contact.You can also connect us here...')}}</h5>
              ...
              <div class="row">
                ...
                <div class="col-lg-8">
                  <div class="contact__form">
                    <div class="small-title">
                      <h4>{{__('contact.Just send us your questions or concerns by starting a new case and we will give you the help you need.')}}</h4>
                      <p></p>
                    </div>
                    ...
                    <div class="comment-box">
                      <form class="m-t-40"  id="contact-form" enctype="multipart/form-data">
                        ...
                        <div class="single-input">
                          <input id="name" type="text" class="form-control" name="name" value="{{old('name')}}" placeholder="{{__('contact.Enter your name')}}" required>
                          
                        </div>
                        <div class="single-input">
                          <input id="email" type="email" class="form-control" name="email" value="{{old('email')}}" placeholder="{{__('contact.Your email')}}"required>
                        </div>
                        <div class="single-input">
  ...
  <optgroup label="Other countries">
    ...
    <option data-countryCode="ZW" value="+263">Zimbabwe (+263)</option>
                          ...
                          <div class="single-input">
                          <input id="phone" type="tel" class="form-control" name="phone" value="{{old('phone')}}" placeholder="{{__('contact.Enter your phone no')}}" required minlength="10" maxlength="20">
                        </div>
                        <div class="single-input">
                          <input id="subject" type="text" class="form-control" name="subject" value="{{old('subject')}}" placeholder="{{__('contact.Subject')}}" required minlength="8" maxlength="20">
                        </div>
                        <div class="single-input textarea">
                          <textarea id="message" cols="3" class="form-control" name="message" value="{{old('message')}}" rows="3" placeholder="{{__('contact.Write your message here')}}" required minlength="30"></textarea>

                        </div>
                        <div class="single-input">
                          <button type="submit" class="btn btn-info cr-btn cr-btn--transparent">{{__('contact.Send')}}</button>
                        </div>
                      </form>
                ...
                <div class="col-lg-4">
                  <img src="{{url('/frontend_asset/images/about/contact.jpg')}}" alt="contact image">
                </div>
              </div>
            </div>
