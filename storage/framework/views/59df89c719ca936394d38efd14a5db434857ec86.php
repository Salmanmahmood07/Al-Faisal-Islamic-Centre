...
<?php $__env->stopSection(); ?>
  ...
  <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Manage Mission</h3>
                </div>
  ...
  <div class="container-fluid">
    <div class="row">
    <div class="col-md-2">
    <a href="<?php echo e(url('admin/addmissionimages',$mission->id)); ?>"><button type="button" class="btn waves-effect waves-light  btn-info" data-toggle="modal" data-target="#exampleModal"
                              ...
                              <form class="m-t-40"  id="mission-form" enctype="multipart/form-data" >
                                ...
                                <?php echo csrf_field(); ?>
                                  ...
                                  <div class="form-group m-b-40">
                                      <label for="input1">Mission Title</label>
                                      <input type="text" class="form-control" value="<?php echo e($mission->title); ?>" name="title" id="title">
                                      <span class="bar"></span>

                                  </div>

                                  <div class="form-group m-b-40">
                                    <label for="input2">Mission Description</label>

                                      <textarea name="description" class="form-control"  id="description">

                                    <?php if($mission): ?>
                                    <h2><?php echo e($mission->content); ?></h2>
                                          <?php else: ?>
                                          <h2>good</h2>
                                    <?php endif; ?>
                                      </textarea>
              ...
              jQuery(document).ready(function(){
                ...
                jQuery('#mission-form').submit(function(e){
                  ...
                  var form_data=$("#mission-form").serialize();
                    jQuery.ajax({
                      url: "<?php echo e(url('/admin/updatemission')); ?>",
                      method : 'post',
                      data: form_data,
...
<?php echo $__env->make('admin.masterpage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\salma\faisal-center\resources\views/admin/editmission.blade.php ENDPATH**/ ?>