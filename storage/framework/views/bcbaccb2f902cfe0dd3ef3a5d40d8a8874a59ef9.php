              ...
              <div class="col-lg-12">
                ...
                <nav class="menu">
                  <ul class="justify-content-end">
                    ...
                    <!-- <li ><a href="<?php echo e(url('/api/onlinetutoring')); ?>"><?php echo e(__('header.Online Tutoring')); ?></a>
                    </li> -->
...
<?php /**PATH C:\xampp\htdocs\Laravel\faisal-center\resources\views/frontend/layouts/header.blade.php ENDPATH**/ ?>