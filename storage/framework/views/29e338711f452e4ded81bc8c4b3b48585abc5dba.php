                  ...
                  <div class="col-12">
                      <div class="card">
                          ...
                          <div class="card-body">
                              ...
                              <form class="m-t-40"  id="services-form" enctype="multipart/form-data" >
              ...
              jQuery(document).ready(function(){
                ...
                jQuery('#services-form').submit(function(e){
                  ...
                  var formData = new FormData(myForm);
                    jQuery.ajax({
                      url: "<?php echo e(url('/admin/postservice')); ?>",
                      method : 'post',
                      data: formData,
                      contentType: false,
                       cache: false,
...
<?php echo $__env->make('admin.masterpage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\salma\faisal-center\resources\views/admin/addservices.blade.php ENDPATH**/ ?>