...
<?php $__env->stopSection(); ?>
                  ...
                  <div class="col-12">
                      <div class="card">
                          ...
                          <div class="card-body">
                              ...
                              <form class="m-t-40"  id="project-form" enctype="multipart/form-data" >
  ...
  width: 150px;"  alt="Your selected image..." />
                                  ...
                                  <div class="form-group m-b-40">
                                    <label for="input2">Project Start Date</label>

                                      <input type="date" name="startdate" value="<?php echo e(old('date')); ?>" class="form-control"  required>
                                      <span class="bar"></span>
                                  </div>
                                  <!-- <div class="form-group m-b-40">
            ...
            <script type="text/javascript">
              ...
              jQuery(document).ready(function(){
                ...
                jQuery('#project-form').submit(function(e){
                  ...
                  // var form_data=$("#project-form").serialize();
                  var myForm = document.getElementById('project-form');
                  var formData = new FormData(myForm);
                    jQuery.ajax({
                      url: "<?php echo e(url('/admin/postproject')); ?>",
                      method : 'post',
                      data: formData,
                      contentType: false,
                       cache: false,
...
<?php echo $__env->make('admin.masterpage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\salma\faisal-center\resources\views/admin/addprojects.blade.php ENDPATH**/ ?>