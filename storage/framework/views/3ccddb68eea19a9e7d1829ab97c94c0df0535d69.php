                  ...
                  <div class="col-12">
                      <div class="card">
                          ...
                          <div class="card-body">
                              ...
                              <form class="m-t-40"  id="course-form" enctype="multipart/form-data" >
  ...
  width: 150px;"  alt="Your selected image..." />
            ...
            <script type="text/javascript">
              ...
              jQuery(document).ready(function(){
                ...
                jQuery('#course-form').submit(function(e){
                  e.preventDefault();
                  $.ajaxSetup({
                    headers: {
                  ...
                  var myForm = document.getElementById('course-form');
                  var formData = new FormData(myForm);
                    jQuery.ajax({
                      url: "<?php echo e(url('/admin/postcourse')); ?>",
                      method : 'post',
                      data: formData,
                      contentType: false,
                       cache: false,
...
<?php echo $__env->make('admin.masterpage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\salma\faisal-center\resources\views/admin/addcourses.blade.php ENDPATH**/ ?>