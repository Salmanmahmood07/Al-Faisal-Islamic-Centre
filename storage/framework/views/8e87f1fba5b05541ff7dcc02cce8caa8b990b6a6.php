          ...
          <div class="col-lg-8 col-xl-9">
            <div class="event-details">
              <div class="event-details__thumb">
                <img src="<?php echo e(url('/assets/courses')); ?>/<?php echo e($detail->image); ?>" style="width:100%;height:400px;" alt="Single event Details">
              </div>
              <h2 class="event-details__title"><?php echo e($detail->coursetitle); ?></h2>
          ...
          <div class="col-lg-4 col-xl-3">
            ...
            <div class="sidebar widgets">
              ...
              <div class="single-widget wgt-recentpost">
                ...
                <ul>
                  <?php $__currentLoopData = $courses_detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <li>
                    <div class="wgt-recentpost__thumb">
                      <a href="<?php echo e(url('/courses_detail',$course->id)); ?>">
                        <img src="<?php echo e(url('/assets/courses')); ?>/<?php echo e($course->image); ?>" alt="event thumb">
                      </a>
                    </div>
                    <div class="wgt-recentpost__content">
                      <h5><a href="<?php echo e(url('/courses_detail',$course->id)); ?>"><?php echo e($course->coursetitle); ?></a></h5>
                      <p><span><?php echo e(date("d M Y", strtotime($course->created_at))); ?></span></p>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\faisal-center\resources\views/frontend/coursesdetail.blade.php ENDPATH**/ ?>