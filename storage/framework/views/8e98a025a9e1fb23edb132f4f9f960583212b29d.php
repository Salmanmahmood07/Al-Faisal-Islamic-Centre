...
<?php $__env->stopSection(); ?>
  ...
  <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Manage about</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>

                        <li class="breadcrumb-item active">Add More Images</li>
                    </ol>
                </div>
            </div>
                  ...
                  <div class="col-12">
                      <div class="card">
                          ...
                          <div class="card-body">
                              ...
                              <form class="m-t-40"  id="vision-form" enctype="multipart/form-data" >

                                <?php echo csrf_field(); ?>

                                  <div class="form-group m-b-40">
                                    <input type="hidden" class="form-control" value="<?php echo e($vision->id); ?>" name="id" id="title" required >
                                    <label for="input2">  Image</label>

                                      <input type="file" name="images[]" value="<?php echo e(old('images')); ?>" class="form-control"  required onchange="readURL(this);" multiple="" >
  ...
  width: 150px;"  alt="Your selected image..." />
            ...
            <script type="text/javascript">
              ...
              jQuery(document).ready(function(){
                ...
                jQuery('#vision-form').submit(function(e){
                  e.preventDefault();
                  $.ajaxSetup({
                    headers: {
                  ...
                  var myForm = document.getElementById('vision-form');
                  var formData = new FormData(myForm);
                    jQuery.ajax({
                      url: "<?php echo e(url('/admin/addvisimage')); ?>",
                      method : 'post',
                      data: formData,
                      contentType: false,
                       cache: false,
...
<?php echo $__env->make('admin.masterpage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\salma\faisal-center\resources\views/admin/addvisionimages.blade.php ENDPATH**/ ?>