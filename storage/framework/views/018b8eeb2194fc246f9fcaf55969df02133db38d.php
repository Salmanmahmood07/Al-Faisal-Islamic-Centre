  ...
  <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Add Imam</li>
                    </ol>
                </div>
            </div>
                                ...
                                <?php echo csrf_field(); ?>
                                  ...
                                  <div class="form-group m-b-40">
                                    ...
                                    <div class="form-group m-b-40">
                                      ...
                                      <input type="text" class="form-control" value="<?php echo e(old('designation')); ?>" name="designation" id="title" required >
                                      <span class="bar"></span>
              ...
              jQuery(document).ready(function(){
                ...
                jQuery('#imam-form').submit(function(e){
                  ...
                  var formData = new FormData(myForm);
                    jQuery.ajax({
                      url: "<?php echo e(url('/admin/imamadd')); ?>",
                      method : 'post',
                      data: formData,
                      contentType: false,
                       cache: false,
...
<?php echo $__env->make('admin.masterpage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\salma\faisal-center\resources\views/admin/addimam.blade.php ENDPATH**/ ?>