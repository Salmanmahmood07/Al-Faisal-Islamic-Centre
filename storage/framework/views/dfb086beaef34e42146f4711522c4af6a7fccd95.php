              ...
              jQuery(document).ready(function(){
                ...
                jQuery('#image-form').submit(function(e){
                  ...
                  var formData = new FormData(myForm);
                    jQuery.ajax({
                      url: "<?php echo e(url('/admin/addimagecategory')); ?>",
                      method : 'post',
                      data: formData,
                      contentType: false,
                       cache: false,
...
<?php echo $__env->make('admin.masterpage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\salma\faisal-center\resources\views/admin/imagecategory.blade.php ENDPATH**/ ?>