                              ...
                              <form class="m-t-40"  id="mission-form" enctype="multipart/form-data" >
                                ...
                                <?php echo csrf_field(); ?>
                                  ...
                                  <div class="form-group m-b-40">
                                    <input type="hidden" class="form-control" value="<?php echo e($mission->id); ?>" name="id" id="title" required >
            ...
            <script type="text/javascript">
              ...
              jQuery(document).ready(function(){
                ...
                jQuery('#mission-form').submit(function(e){
                  ...
                  var myForm = document.getElementById('mission-form');
                  var formData = new FormData(myForm);
                    jQuery.ajax({
                      url: "<?php echo e(url('/admin/addmissimage')); ?>",
                      method : 'post',
                      data: formData,
                      contentType: false,
                       cache: false,
...
<?php echo $__env->make('admin.masterpage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\salma\faisal-center\resources\views/admin/addmissionimages.blade.php ENDPATH**/ ?>