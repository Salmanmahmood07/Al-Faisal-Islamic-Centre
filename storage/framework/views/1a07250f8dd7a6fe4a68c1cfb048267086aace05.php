        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <!-- <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false">
                        ...
                        <ul aria-expanded="false" class="collapse">
                            <li><a href="<?php echo e(url('admin/meetinginvite')); ?>">Create Invitations</a></li>
                            <li><a href="<?php echo e(url('/admin/getallinvite')); ?>">All Meetings</a></li>
                        </ul>
                </li> -->
...
<?php /**PATH C:\xampp\htdocs\Laravel\faisal-center\resources\views/admin/header.blade.php ENDPATH**/ ?>