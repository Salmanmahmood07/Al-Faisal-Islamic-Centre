                ...
                <figure class="activity wow fadeInLeft">
                  <div class="activity__thumb">
                    <a href="<?php echo e(url('/project_detail',$project->id)); ?>">
                      <img src="<?php echo e(url('/assets/projects')); ?>/<?php echo e($project->image); ?>" alt="activity image" style="height: 250px; width: 450px;">
                    </a>
                  </div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\faisal-center\resources\views/frontend/projects.blade.php ENDPATH**/ ?>