                          ...
                          <div class="card-body">
                              ...
                              <form class="m-t-40"  id="courses-form" >
                                ...
                                <div class="form-group m-b-40">
                                    ...
                                    <input type="hidden" class="form-control" value="<?php echo e($courses->id); ?>" name="id" id="title" required >


                                </div>
                                  <div class="form-group m-b-40">
                                      <label for="input1">Course Title</label>
                                      <input type="text" class="form-control" value="<?php echo e($courses->coursetitle); ?>" name="title" id="title">
                                      <span class="bar"></span>
                                  ...
                                  <div class="form-group m-b-40">
                                    <label for="input2"> Course Description</label>
                                      ...
                                      <textarea name="description" class="form-control"  id="content"  ><?php echo e($courses->description); ?></textarea>
                                      <span class="bar"></span>
                                  </div>
                                  ...
                                  <div class="form-group m-b-40">
                                    <label for="input2"> Course Image</label>
                                      ...
                                      <input type="file" name="images" value="<?php echo e(old('images')); ?>" class="form-control"   onchange="readURL(this);">
                                        <img id="blah" src="<?php echo e(url('/assets/courses')); ?>/<?php echo e($courses->image); ?>" height="200" width="100" style="border: 1px solid #ddd;
  border-radius: 4px;
  padding: 5px;
  width: 150px;"  alt="Your selected image..." />
                                  ...
                                  <div class="form-group m-b-40">
                                    <label for="input2"> Image AltText</label>
                                      ...
                                      <input type="text" name="alttext" value="<?php echo e($courses->alttext); ?>" class="form-control" id="alttext">
                                      <span class="bar"></span>
                                  </div>
          ...
          focus: true                  // set focus to editable area after initializing summernote
                ...
                jQuery('#courses-form').submit(function(e){
                  ...
                  var formData = new FormData(myForm);
                    jQuery.ajax({
                      url: "<?php echo e(url('/admin/coursesedit')); ?>",
                      method : 'post',
                      data: formData,
                      contentType: false,
                       cache: false,
...
<?php echo $__env->make('admin.masterpage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\salma\faisal-center\resources\views/admin/editcourse.blade.php ENDPATH**/ ?>