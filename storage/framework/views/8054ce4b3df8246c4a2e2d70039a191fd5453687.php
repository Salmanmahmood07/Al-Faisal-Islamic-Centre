                              ...
                              <form class="m-t-40"  id="meeting-form" enctype="multipart/form-data" >
                                ...
                                <?php echo csrf_field(); ?>
                                  ...
                                  <div class="form-group m-b-40">
                                   ...
                                   <input type="text" class="form-control" value="<?php echo e(old('title')); ?>" name="topic" id="topic" required >
                                  <span class="bar"></span>
                                </div>
                                <div class="form-group m-b-40">
                                   <label for="input2"> Agenda</label>
                                   <input type="text" class="form-control" value="<?php echo e(old('title')); ?>" name="agenda" id="agenda" required >
                                  <span class="bar"></span>
                                </div>
                                <div class="form-group m-b-40">
                                   <label for="input2">Date</label>&nbsp;<span class="bar">Format:&nbsp;M/D/Y&nbsp;Time&nbsp;(02/04/2021&nbsp;01:38 PM)</span>
                                   <input type="text" class="form-control" value="<?php echo e(old('title')); ?>" name="start_time" id="start_time" required >
                                  <span class="bar"></span>
                                </div>
              ...
              jQuery(document).ready(function(){
                ...
                jQuery('#meeting-form').submit(function(e){
                  ...
                  var formData = new FormData(myForm);
                    jQuery.ajax({
                      url: "<?php echo e(url('/api/meetingsc')); ?>",
                      method : 'post',
                      data: formData,
                      contentType: false,
                       cache: false,
...
<?php echo $__env->make('admin.masterpage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\faisal-center\resources\views/admin/meetinginvite.blade.php ENDPATH**/ ?>