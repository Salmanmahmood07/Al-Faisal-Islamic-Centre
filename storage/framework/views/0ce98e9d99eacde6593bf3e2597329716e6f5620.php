          ...
          <div class="col-lg-8 col-xl-9">
            <div class="event-details">
              <div class="event-details__thumb">
                  <img src="<?php echo e(url('/assets/events')); ?>/<?php echo e($detail->newsimage); ?>" style="width:100%;height:400px;" alt="Single event Details">
              </div>
              <h2 class="event-details__title"><?php echo e($detail->title); ?></h2>
              <div class="event-details__meta">
                <ul>
                  <li><span>Date:</span> <?php echo e(date("d M Y", strtotime($detail->date))); ?></li>
              ...
              <div class="calltoaction d-flex justify-content-left justify-content-md-center flex-wrap felx-md-nowrap">
                <h3>Let’ s join the event, know about <?php echo e($detail->title); ?>...</h3>
                      ...
                      <div class="hexagon">
                        <div class="hexagon__inner1">
                          <div class="hexagon__inner2">
                            <img src="<?php echo e(url('/assets/imams')); ?>/<?php echo e($detail->imamimage); ?>" alt="speaker 1">
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="signle-speaker__content">
                      <h5><?php echo e($detail->imam); ?></h5>
                      <span><?php echo e($detail->designation); ?></span>
                    </div>
                  </div><!-- //Single Speaker -->
                  <!-- Single Speaker -->
          ...
          <div class="col-lg-4 col-xl-3">
            ...
            <div class="sidebar widgets">
              ...
              <div class="single-widget wgt-recentpost">
                ...
                <ul>
                  <?php $__currentLoopData = $event_detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <li>
                    <div class="wgt-recentpost__thumb">
                      <a href="<?php echo e(url('/event_detail',$event->id)); ?>">
                        <img src="<?php echo e(url('/assets/events')); ?>/<?php echo e($event->image); ?>" alt="event thumb">
                      </a>
                    </div>
                    <div class="wgt-recentpost__content">
                      <h5><a href="<?php echo e(url('/event_detail',$event->id)); ?>"><?php echo e($event->title); ?></a></h5>
                      <p><span><?php echo e($event->venue); ?></span><span><?php echo e(date("d M Y", strtotime($event->created_at))); ?></span></p>
                    </div>
                  </li>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\salma\faisal-center\resources\views/frontend/eventdetail.blade.php ENDPATH**/ ?>