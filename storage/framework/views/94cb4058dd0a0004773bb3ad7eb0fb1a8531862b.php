        ...
        <div class="row">
          <div class="col-lg-12 text-center">
            <div class="cr-breadcrumb text-center">
              <h2 class="cr-breadcrumb__title">Services Details</h2>
          ...
          <div class="col-lg-8 col-xl-9">
            <div class="event-details">
              <div class="event-details__thumb">
                <img src="<?php echo e(url('/assets/services')); ?>/<?php echo e($detail->image); ?>" style="width:100%;height:400px;" alt="Single event Details">
              </div>
              <h2 class="event-details__title"><?php echo e($detail->servicetitle); ?></h2>
          ...
          <div class="col-lg-4 col-xl-3">
            ...
            <div class="sidebar widgets">
              ...
              <div class="single-widget wgt-recentpost">
                ...
                <ul>
                  <?php $__currentLoopData = $service_detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <li>
                    <div class="wgt-recentpost__thumb">
                      <a href="<?php echo e(url('/services_detail',$service->id)); ?>">
                        <img src="<?php echo e(url('/assets/services')); ?>/<?php echo e($service->image); ?>" alt="event thumb">
                      </a>
                    </div>
                    <div class="wgt-recentpost__content">
                      <h5><a href="<?php echo e(url('/services_detail',$service->id)); ?>"><?php echo e($service->servicetitle); ?></a></h5>
                      <p><span><?php echo e(date("d M Y", strtotime($service->created_at))); ?></span></p>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\salma\faisal-center\resources\views/frontend/servicesdetail.blade.php ENDPATH**/ ?>