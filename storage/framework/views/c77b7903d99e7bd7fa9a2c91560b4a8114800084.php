    ...
    <div class="row">
      ...
      <div class="col-md-2">
        <button type="button" class="btn waves-effect waves-light  btn-info del-button" data-toggle="modal" data-target="#exampleModal"
         style="margin-left:200px;">Add Category</button>
      </div>
      ...
      <div class="modal-body">
        <form id="category-form">
          ...
          <div class="form-group">
            ...
            <input type="text" name="videocategorytitle" class="form-control" required>
                              ...
                              <form class="m-t-40"  id="video-form" enctype="multipart/form-data" >
                                ...
                                <?php echo csrf_field(); ?>
                                  ...
                                  <div class="form-group m-b-40">
                                    ...
                                    <select class="form-control p-0" id="category" name="category" required>
                                        <option selected="true" disabled="disabled">Choose Category</option>
                                      <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <option value="<?php echo e($cat->id); ?>" id="catoption"><?php echo e($cat->categorytitle); ?></option>
                               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                  ...
                                  <div class="form-group m-b-40">
                                    <label for="input2"> Video Embed</label>
                                      ...
                                      <input type="text" name="videoembed" value="<?php echo e(old('videoembed')); ?>" class="form-control"  required  >
              ...
              jQuery(document).ready(function(){
                ...
                jQuery('#video-form').submit(function(e){
                  ...
                  // var formData = new FormData(myForm);
                    ...
                    jQuery.ajax({
                      url: "<?php echo e(url('/admin/postvideo')); ?>",
                      method : 'post',
                      data: form_data,
...
<?php echo $__env->make('admin.masterpage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\salma\faisal-center\resources\views/admin/addvideo.blade.php ENDPATH**/ ?>